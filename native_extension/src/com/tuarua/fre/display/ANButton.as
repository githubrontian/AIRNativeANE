...
[RemoteClass(alias="com.tuarua.fre.display.ANButton")]
public class ANButton extends ANDisplayObject {
    ...
    public function ANButton(upState:Bitmap, overState:Bitmap, downState:Bitmap = null) {
        _upState = upState;
        ...
        ANContext.getContext().addEventListener(StatusEvent.STATUS, gotNativeEvent);
    }
