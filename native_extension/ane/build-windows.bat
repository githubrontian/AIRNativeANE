...
SET projectName=AIRNativeANE
SET cSharpLib=AIRNative
...
copy %pathtome%..\..\native_library\win\%projectName%\Debug\%cSharpLib%.dll %AIR_PATH%%cSharpLib%.dll
copy %pathtome%..\..\native_library\win\%projectName%\Debug\%cSharpLib%.pdb %AIR_PATH%%cSharpLib%.pdb

copy %pathtome%..\..\native_library\win\%projectName%\Release\%cSharpLib%.dll %pathtome%..\..\c_sharp_libs\%cSharpLib%.dll
copy %pathtome%..\..\native_library\win\%projectName%\Release\%cSharpLib%.dll %pathtome%..\..\..\FreSharp\example\c_sharp_libs\%cSharpLib%.dll
